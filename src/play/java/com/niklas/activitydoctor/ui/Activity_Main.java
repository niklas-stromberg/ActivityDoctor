...
import com.niklas.activitydoctor.util.GoogleFit;
import com.niklas.activitydoctor.util.Logger;
import com.niklas.activitydoctor.util.PlayServices;
...
public class Activity_Main extends FragmentActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onStart() {
        ...
        if (getSharedPreferences("activitydoctor_playservices", Context.MODE_PRIVATE)
    ...
    public void signOut() {
        ...
        getSharedPreferences("activitydoctor_playservices", Context.MODE_PRIVATE).edit()
    ...
    public boolean optionsItemSelected(final MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_about:
                ...
                builder.create().show();
                break;
            case R.id.action_recommended_activity:
                AlertDialog.Builder builder2 = new AlertDialog.Builder(this);
                builder2.setTitle(R.string.doctors_recommendation);
                TextView tv2 = new TextView(this);
                tv2.setPadding(75, 20, 20, 20);

                tv2.setText(R.string.doctors_recommendation_text);

                tv2.setMovementMethod(LinkMovementMethod.getInstance());
                builder2.setView(tv2);
                builder2.setPositiveButton(android.R.string.ok,
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(final DialogInterface dialog, int which) {
                ...
                builder2.create().show();
                break;
            case R.id.action_explanations:
                AlertDialog.Builder builder3 = new AlertDialog.Builder(this);
                builder3.setTitle(R.string.explanations);
                TextView tv3 = new TextView(this);
                tv3.setPadding(75, 20, 20, 20);

                tv3.setText(R.string.explanations_text);

                tv3.setMovementMethod(LinkMovementMethod.getInstance());
                builder3.setView(tv3);
