    ...
    public static void setupAccountSetting(final Preference account,
        ...
        account.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(final Preference preference) {
                ...
                View v = main.getLayoutInflater().inflate(com.niklas.activitydoctor.R.layout.signin, null);
                builder.setView(v);
                ...
                if (main.getGC().isConnected()) {
                    ((TextView) v.findViewById(com.niklas.activitydoctor.R.id.signedin)).setText(
                            main.getString(com.niklas.activitydoctor.R.string.signed_in,
                                    Games.Players.getCurrentPlayer(main.getGC()).getDisplayName()));
                    v.findViewById(com.niklas.activitydoctor.R.id.sign_in_button).setVisibility(View.GONE);
                    builder.setPositiveButton(com.niklas.activitydoctor.R.string.sign_out,
                            new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    main.signOut();
                                    preference.setSummary(main.getString(com.niklas.activitydoctor.R.string.sign_in));
                                    dialog.dismiss();
                                }
                            });
                }
                ...
                if (!main.getGC().isConnected()) {
                    v.findViewById(com.niklas.activitydoctor.R.id.signedin).setVisibility(View.GONE);
                    v.findViewById(com.niklas.activitydoctor.R.id.sign_in_button)
        ...
        {
            account.setSummary(main.getString(com.niklas.activitydoctor.R.string.signed_in, savedInstanceState == null ?
                    Games.Players.getCurrentPlayer(main.getGC()).getDisplayName() :
